    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='release_currency', to='users.profilecurrency')),
                ('release', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='release', to='releases.release')),
            ],
        ),
        migrations.CreateModel(
            name='MarketingInfos',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('release', 'currency'), name='unique_release_per_currency'),
        ),
    ]
