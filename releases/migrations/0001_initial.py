    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_at', models.DateTimeField(verbose_name='submitted date')),
                ...
                ('cover_image', models.ImageField(help_text='Select image with minimum size of 800x800 pixel', storage=configuration.file_storage.DuplicationFixFileSystemStorage(), upload_to='images/covers/', verbose_name='Front cover image')),
                ('format', models.CharField(choices=[('CD', 'CD'), ('Vinyl', 'Vinyl'), ('Tape', 'Tape'), ('DVD', 'DVD')], default='CD', max_length=5)),
                ('sample', models.FileField(help_text='Upload up to 1 minute sample of the album to give fellow label owners a taste of this release', storage=configuration.file_storage.DuplicationFixFileSystemStorage(), upload_to='audios/releases/', validators=[releases.models.release.validate_file_size, django.core.validators.FileExtensionValidator(['mp3'])])),
