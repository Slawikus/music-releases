    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_style', models.CharField(choices=[('Classical', 'Classical'), ('Country', 'Country'), ('EDM', 'EDM'), ('Hip-Hop', 'Hip-Hop'), ('Indie Rock', 'Indie Rock'), ('Jazz', 'Jazz'), ('K-pop', 'K-pop'), ('Metal', 'Metal'), ('Oldies', 'Oldies'), ('Pop', 'Pop'), ('Rap', 'Rap'), ('Rhythm & blues (R&B)', 'Rhythm & blues (R&B)'), ('Rock', 'Rock'), ('Techno', 'Techno')], max_length=250)),
