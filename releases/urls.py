...
urlpatterns = [
    ...
    path('<int:pk>/do-favourite', views.CreateFavouriteReleaseView.as_view(), name='do_favourite'),
    ...
    path("favourite-releases/", views.FavouriteReleasesView.as_view(), name='favourite-releases'),
