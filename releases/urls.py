...
urlpatterns = [
    ...
    path('<int:pk>/trades_info', UpdateReleaseTradesInformationView.as_view(), name='release_trades_info_edit'),
    path('<int:pk>/wholesale_info', UpdateReleaseWholesaleInformationView.as_view(), name='release_wholesale_info_edit'),
